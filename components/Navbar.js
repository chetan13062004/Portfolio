            ...
            <div className="flex items-center justify-between w-full sm:mx-10 md:mx20">
              ...
              <div className="hidden md:block">
                <div className="ml-10 space-x-4 flex items-baseline font-semibold">
                  <Link href='/about' to='about' smooth={true} offset={50} duration={500} className='text-md hover:text-blue-500 px-3 py-2 cursor-pointer'>About</Link>
                  <Link href="/skills" to="skills" smooth={true} offset={50} duration={500} className='text-md hover:text-blue-500 px-3 py-2 cursor-pointer'>Skills</Link>
                  <Link href='/works' to='works' smooth={true} offset={50} duration={500} className='text-md hover:text-blue-500 px-3 py-2 cursor-pointer'>Projects</Link>
                  <Link href="/contact" to="contact" smooth={true} offset={50} duration={500} className='text-md hover:text-blue-500 px-3 py-2 cursor-pointer'>Contact</Link>
                </div>
              </div>

              {/* Theme Toggle */}
              <div onClick={handleThemeChange} className="flex justify-center items-center pr-8 flex-shrink-0 invisible md:visible cursor-pointer">
